...
namespace LodeRunner.API.Test.IntegrationTests.ExecutingTestRun
{
    ...
    public class TestRunExecution : IClassFixture<ApiWebApplicationFactory<Startup>>
    {
        ...
        [Trait("Category", "Integration")]
        [Theory]
        [InlineData(1, 5000, false, LodeRunner.Core.SystemConstants.TestRunExecutionStoppedMessage, 3)]
        [InlineData(1, 5000, true, LodeRunner.Core.SystemConstants.OperationCanceledException, 3)]
