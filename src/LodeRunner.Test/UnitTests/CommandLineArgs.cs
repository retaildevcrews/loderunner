...
namespace LodeRunner.Test.UnitTests
{
    ...
    public class CommandLineArgs
    {
        ...
        [InlineData(new string[] { "--mode", Core.SystemConstants.LodeRunnerCommandMode, "-s", "https://somerandomdomain.com", "-f", "memory-baseline.json", "--sleep", "sleep" }, "must be an integer >= 1", "Minimum requirements not met for argument --sleep")]
