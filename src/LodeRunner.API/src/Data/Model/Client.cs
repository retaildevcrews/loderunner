...
namespace LodeRunner.API.Models
{
    ...
    public class Client
    {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1629:Documentation text should end with a period", Justification = "Use to generate swagger example.")]
